...
/*ListUsersOK A paged array of users
...
// WithXNext adds the xNext to the list users o k response
func (o *ListUsersOK) WithXNext(xNext string) *ListUsersOK {
	o.XNext = xNext
	return o
}

// SetXNext sets the xNext to the list users o k response
func (o *ListUsersOK) SetXNext(xNext string) {
	o.XNext = xNext
}
