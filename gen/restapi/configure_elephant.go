...
import (
	...
	"github.com/myzie/elephant/gen/restapi/operations"
)

//go:generate swagger generate server --target ../gen --name Elephant --spec ../swagger.yml

func configureFlags(api *operations.ElephantAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.ElephantAPI) http.Handler {
